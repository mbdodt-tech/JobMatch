...
export default function ManagerSettings() {
  ...
  const toggles = [
    { key: 'push', label: 'Push-notifikationer', desc: 'Besked når en elev swiper right', icon: Smartphone, value: notifyPush, set: setNotifyPush, color: 'text-[#0B6B60]' },
    { key: 'email', label: 'Email-notifikationer', desc: 'Daglig opsummering af nye matches', icon: Mail, value: notifyEmail, set: setNotifyEmail, color: 'text-[#0B6B60]' },
    { key: 'inapp', label: 'In-app notifikationer', desc: 'Vis badges og bannere', icon: Bell, value: notifyInApp, set: setNotifyInApp, color: 'text-[#0B6B60]' },
  ];
